...
                    local ShootEffect = CurrentWeapon.ShootWeaponEffect or (shootComp and (shootComp.ShootWeaponEffectComponent or shootComp:GetShootWeaponEffectComponent()))
...
                               local AutoAimingConfig = ShootEntity.AutoAimingConfig
                               local InnerRange = AutoAimingConfig.InnerRange  
                               local OuterRange = AutoAimingConfig.OuterRange  
                               if InnerRange then
                                   InnerRange.Speed = 8
                                   InnerRange.SpeedRate = 5
                                   InnerRange.SpeedRateSight = 3
                                   InnerRange.DyingRate = 0.1
                               end
                               if OuterRange then
                                   OuterRange.Speed = 8
                                   OuterRange.SpeedRate = 5
                                   OuterRange.SpeedRateSight = 3
                                   OuterRange.DyingRate = 0.1
                               end
